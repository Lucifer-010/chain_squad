...
SECRET_KEY = 'django-insecure-i041be1qhsbqm@131=3$$d315-1re2z$13p^dl&1n!qh&$a*r5'
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_SCHEMA_CLASS': 'rest_framework.schemas.coreapi.AutoSchema', # Already present, but good to confirm
}
